...
private _nextUpdateTime = _player getVariable ["nextVehConnCheck", CBA_missionTime];
// Return cached value if the last update was less than 3s ago
private _cachedReturn = _player getVariable ["cachedVehConnCheck", false];
...
_player setVariable ["nextVehConnCheck", CBA_missionTime + 3];
_player setVariable ["cachedVehConnCheck", _connEstablished];
