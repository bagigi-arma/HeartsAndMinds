...
if (isServer) then {
    ...
    //Side
    btc_side_ID = 0;
    btc_side_list = [/*"supply", */"mines", /*"vehicle", */"get_city", "tower", /*"civtreatment", */"checkpoint", "convoy", "rescue", "capture_officer", "hostage", "hack", "kill", "massacre", "EMP"/*, "removeRubbish"*/]; // On ground (Side "convoy" and "capture_officer" are not design for map with different islands. Start and end city can be on different islands.)
...
btc_w_civs = [
    ["rhs_weap_kar98k", "rhs_weap_Izh18", "rhs_weap_pm63"],
    ["rhs_weap_makarov_pm", "rhs_weap_savz61_folded"]
];
...
//FOB
btc_fob_mat = "Land_Cargo10_military_green_F";
btc_fob_structure = "USMC_WarfareBBarracks";
btc_fob_flag = "Infostand_1_EP1";
btc_fob_id = 0;
...
//Supplies
btc_supplies_cargo = "Land_Cargo10_orange_F";
btc_supplies_mat = [
...
btc_respawn_marker = "respawn_guer";
...
_p_en = "ua_co_army";//_allfaction select _p_en; //Select faction selected from mission parameter
...
switch (_p_en) do {
    ...
    case "ua_co_army" : {
        btc_type_units = ["ua_co_army_Squad_Leader", "ua_co_army_Rifleman_Light", "ua_co_army_Rifleman_AT", "ua_co_army_Rifleman", "ua_co_army_Marksman", "ua_co_army_Machinegunner", "ua_co_army_Grenadier", "ua_co_army_Explosive_Specialist", "ua_co_army_Combat_Life_Saver"/*, "ua_co_army_Officer"*/];
        // Da aggiungere eventualmente in una variabile nuova per una nuova feature H&M che spawna team sniper nascosti: ["ua_co_army_Sniper", "ua_co_army_Spotter"]
        btc_type_crewmen = "ua_co_army_Rifleman";
        btc_type_divers = [];
        btc_type_mg = ["ua_co_m240_low", "ua_co_m240_high", "ua_co_m2_high", "ua_co_m2_low"];
        btc_type_gl = ["ua_co_mk19"];
        btc_type_mortar = ["ua_co_tow_tripod"];
        btc_type_boats = [];
        btc_type_motorized = ["ua_co_m988_4dr", "ua_co_m988_4dr_fulltop", "ua_co_m998_2dr_fulltop", "ua_co_m998_2dr_halftop", "ua_co_m1025", "ua_co_m1152_transport", "ua_co_m939_closed", "ua_co_m1025_m2", "ua_co_m939_guntruck", "ua_co_maxxpro_m2"];
        btc_type_motorized_armed = ["ua_co_m1025_m2", "ua_co_m1025_mk19", "ua_co_m939_guntruck", "ua_co_m113_m2", "ua_co_m113_m240", "ua_co_m113_mk19", "ua_co_m1117", "ua_co_lav25", "ua_co_maxxpro_m2"];
        // elicotteri, aggiungere a `btc_type_motorized_armed` se vogliamo aggiungere QRF aviotrasportate (da testare): ["ua_co_uh1h_unarmed", "ua_co_uh1h_gunship", "ua_co_uh1h"]
    };
};
...
btc_rep_bonus_IEDCleanUp = 20;
btc_rep_bonus_removeTag = 3;
btc_rep_bonus_removeTagLetter = 0.5;
btc_rep_bonus_foodGive = 4;
btc_rep_bonus_grave = 40;
