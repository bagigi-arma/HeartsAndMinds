...
switch (_p_en) do {
    ...
    case "RHSGREF_FACTION_CHDKZ" : {
        btc_type_units = btc_type_units - ["rhsgref_ins_rifleman_akm", "rhsgref_ins_sniper", "rhsgref_ins_pilot", "rhsgref_ins_saboteur", "rhsgref_ins_crew", "rhsgref_ins_commander"];
        btc_type_crewmen = "rhsgref_ins_rifleman_aksu";
        btc_type_divers = [];
        btc_type_mg = ["rhsgref_ins_NSV_TriPod", "rhsgref_ins_DSHKM_Mini_TriPod", "rhsgref_ins_DSHKM"];
        btc_type_gl = ["rhsgref_ins_AGS30_TriPod", "rhsgref_ins_SPG9"];
        btc_type_mortar = ["rhsgref_ins_2b14", "rhsgref_ins_ZU23"];
        btc_type_boats = ["UK3CB_CHD_O_Fishing_Boat_DSHKM", "UK3CB_CHD_O_Small_Boat_Wood"];
        btc_type_motorized = ["rhsgref_ins_uaz","rhsgref_ins_uaz_open","rhsgref_ins_uaz_dshkm","rhsgref_ins_uaz_spg9","rhsgref_ins_ural_open","rhsgref_ins_gaz66","rhsgref_ins_gaz66o","rhsgref_ins_zil131","rhsgref_ins_zil131_open","rhsgref_ins_kraz255b1_fuel","rhsgref_ins_kraz255b1_cargo_open","UK3CB_CHD_O_BTR40","UK3CB_CHD_O_BTR40_PKM","rhsgref_BRDM2UM_ins","rhsgref_BRDM2_HQ_ins"];
        btc_type_motorized_armed = ["UK3CB_O_MTLB_PKT_CHK","UK3CB_O_MTLB_Zu23_CHK","UK3CB_O_T55_CHK","UK3CB_CHD_O_BTR40_PKM","UK3CB_CHD_O_BTR40_MG","rhsgref_ins_uaz_dshkm","rhsgref_ins_uaz_ags","rhsgref_ins_uaz_spg9","rhsgref_ins_ural_Zu23","rhsgref_ins_gaz66_zu23","rhsgref_ins_btr60","rhsgref_ins_bmp1","rhsgref_ins_bmp1d","rhsgref_ins_bmd1","rhsgref_BRDM2_ins","rhsgref_BRDM2UM_ins","rhsgref_BRDM2_HQ_ins"];
    };
};
